...
\begin{itemize}
	...
	\item sugerir novas issues semanticamente coerentes.
\end{itemize}
...
\begin{itemize}
	...
	\item resolver um bug sozinho;
	\item criar uma tela ainda que simples;
	\item aprender um comando do Git.
\end{itemize}
...
\begin{itemize}
	\item comunicação sempre escrita em issues — reduz mal-entendidos;
...
\begin{itemize}
	...
	\item sessão rápida de correção de bugs em grupo;
