...
\begin{itemize}
	\item \textbf{Frontend}: interface com o usuário.
	\item \textbf{Backend}: regras de negócio e lógica da aplicação.
...
\begin{enumerate}
	...
	\item O frontend envia uma requisição ao backend.
	\item O backend processa a lógica e valida informações.
	\item O backend acessa o banco de dados quando necessário.
	\item O backend devolve uma resposta ao frontend.
	\item O frontend atualiza a tela com o resultado.
\end{enumerate}
...
Exemplos usuais em projetos didáticos: HTML/CSS/JS, Python, JavaScript no backend, SQLite ou MariaDB.
...
\begin{itemize}
	...
	\item criar APIs sem padronização de rotas;
...
\begin{enumerate}
	...
	\item Desenhe o fluxo: frontend → backend → banco.
