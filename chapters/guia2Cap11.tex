...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{5. Registro de Bugs (Bug Report)}

Quando o aluno encontra um erro, deve registrar uma issue contendo:
...
\begin{itemize}
	...
	\item commit onde o erro foi identificado.
\end{itemize}

Esse modelo evita perda de informação e facilita correção.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{6. Como Priorizar Bugs}
...
\begin{itemize}
	\item testar toda alteração antes de enviar commit;
	...
	\item registrar e corrigir bugs imediatamente.
\end{itemize}
