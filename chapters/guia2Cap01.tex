...
\begin{itemize}
	...
	\item \textbf{Controle de versão}: Git, integrado ao GitHub;
...
\begin{itemize}
	...
	\item convenção de nomes de branch;
	\item estrutura de pastas do projeto;
	\item modelo de issues;
...
documentação básica: uma issue fechada, um comentário de PR, um trecho de README.
...
\begin{enumerate}
	...
	\item Cria uma branch para testes.
	\item Faz um commit simples para aprender o fluxo.
	\item Envia (push) para o GitHub.
	\item Abre uma Pull Request.
	\item Recebe comentários e ajusta o código.
\end{enumerate}

Esse processo, repetido no início, consolida o uso básico do Git e reduz
bloqueios futuros.
...
\begin{itemize}
	...
	\item \textbf{Gestor de Issues} — cria, mantém e valida clareza das tarefas;
...
\textbf{Problema:} erros constantes com Git.  
...
\begin{enumerate}
	...
	\item Instale o Git e teste rodando \texttt{git --version}.
	...
	\item No VS Code, clique em “Source Control” e faça o commit.
