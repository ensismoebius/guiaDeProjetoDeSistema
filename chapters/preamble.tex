...
% Translate List of Listings -> Lista de Algoritmo s
...
\renewcommand{\imprimircapa}{
	\begin{capa}%
		\center
		\centering \includegraphics[angle=-90]{images/unesp.pdf}
		\vspace{3cm}
...
% Add footnote to glossary entries on first use
