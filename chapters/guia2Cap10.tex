...
\begin{itemize}
	\item \textbf{GitHub \glspl{issue}}: tarefas, \glspl{bug}, solicitações de mudança.
...
\begin{itemize}
	...
	\item tudo que afeta código deve ser registrado em \gls{issue} ou \gls{commit};
...
\begin{itemize}
	\item criar uma \gls{branch} por funcionalidade;
	\item abrir \acp{pr} explicando a mudança;
...
\begin{itemize}
	...
	\item \textbf{Gestor de Tarefas}: atualiza quadro \gls{kanban} e \glspl{issue}.
...
\begin{itemize}
	...
	\item nada é alterado na \textit{\gls{branch} main} sem \ac{pr} aprovado;
...
\begin{enumerate}
	...
	\item atualizações no quadro \gls{kanban}.
\end{enumerate}
...
\begin{itemize}
	...
	\item demonstrar progresso visual no \gls{kanban};
...
\begin{enumerate}
	...
	\item Crie quadro \gls{kanban} e distribua tarefas.
