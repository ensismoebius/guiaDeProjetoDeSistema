...
Conserta falhas e \glspl{bug} encontrados após o uso.
...
\begin{itemize}
	\item \glspl{issue} para gerenciar novas tarefas;
...
\begin{itemize}
	...
	\item comentários claros nas \glspl{issue}.
\end{itemize}
...
\begin{itemize}
	...
	\item \glspl{bug} não resolvidos estão registrados?
...
\begin{enumerate}
	...
	\item crie \glspl{issue} para cada item.
	\item escolha uma melhoria simples.
	\item crie um \gls{branch}.
