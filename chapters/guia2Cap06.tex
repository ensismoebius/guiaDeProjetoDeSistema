...
Após o MVP estar funcionando, inicia-se a etapa de expansão, onde o sistema
...
\begin{itemize}
	...
	\item corrigir falhas estruturais criadas no MVP;
...
Um bom exercício é fazer o professor e colegas utilizarem o MVP “como usuários”, anotando dificuldades.
...
\begin{itemize}
	...
	\item validações mais completas no backend;
	\item melhorias visuais no frontend;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{7. Melhoria do Backend}

O backend cresce em complexidade com a expansão.  
Boas práticas:
...
Evitar deixar o backend virar um amontoado de rotas improvisadas é uma habilidade essencial para iniciantes.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{8. Melhoria do Frontend}

No frontend, melhorias típicas incluem:
...
\begin{itemize}
	\item MVP funcionando sem erros graves.
	...
	\item backend mais organizado;
	\item frontend mais intuitivo.
\end{itemize}
...
\begin{enumerate}
	\item Use o MVP e procure falhas e pontos fracos.
