\chapter{Desenvolvimento do MVP}
O MVP (Produto Mínimo Viável) é a primeira versão funcional do sistema, contendo
apenas o essencial para demonstrar que as funcionalidades básicas existem e
funcionam.  
Esta é a etapa em que o sistema “ganha vida”.  
Para alunos iniciantes, desenvolver um MVP bem estruturado é a melhor forma de
aprender a transformar requisitos em código real.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{1. O Que é o MVP e Por Que Ele Importa?}

O MVP é a menor versão utilizável do sistema.  
...
Focar no MVP evita que alunos gastem semanas em detalhes antes de ter algo funcionando.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{2. Seleção das Funcionalidades Essenciais}

Para definir o que entra no MVP:
...
\begin{enumerate}
	...
	\item Garanta que o MVP possa ser demonstrado em 1–2 minutos.
\end{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{3. Estrutura Modular para o MVP}

Mesmo o MVP deve ser dividido em módulos pequenos e independentes, como:
...
O MVP deve ser construído passo a passo:

\begin{enumerate}
	\item Criar rota simples.
	\item Fazer endpoint responder algo básico.
	\item Exibir esse resultado no frontend.
...
Sugestão prática para iniciar o MVP:

\subsection*{5.1 Backend}
\begin{itemize}
...
\begin{itemize}
	...
	\item Ligar rota do backend ao banco.
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{8. Riscos Comuns no Desenvolvimento do MVP}
...
\begin{enumerate}
	...
	\item Crie uma rota de teste no backend.
	\item Faça o frontend chamar essa rota.
...
O MVP marca o momento em que o projeto deixa de ser apenas planejamento e passa
