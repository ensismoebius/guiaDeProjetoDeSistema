...
\subsection*{3.3 Equipe de Frontend}
Responsável pela interface visual.

\subsection*{3.4 Equipe de Backend}
...
\begin{itemize}
	...
	\item \textbf{Marco 3}: MVP funcionando.
...
\begin{itemize}
	\item Quadro Kanban no GitHub Projects.
...
\begin{enumerate}
	...
	\item Liste os grandes blocos do projeto (requisitos, protótipo, MVP…).
